...
<head>
    ...
    <title>Tanzpartnerbörse - Suche Tanzpartner</title>
</head>
<body>
<nav>
    <?php
...
<main>
    ...
    <div class="content container">
        <?php
        $stmt = $pdo->prepare('SELECT id, username, email, beitrag, jahr, grosse, suche_id, erfahrung, erstellt FROM benutzer WHERE suche_id = 0 ORDER BY erstellt DESC;');
        $stmt->execute();
